import {Link, Routes, Route} from 'react-router-dom'
 ...
 export default function Header({handleToggleCart, itemsCart, totalPrice, itemsFav}) {
      ...
      <Link to='/Sneakers-App/'>
        <div className='d-flex align-center'>
          ...
          <ul className='d-flex '>
            ...
            <Link to='/favorites'>
              <li className='favIcon cu-p' >
                {itemsFav ? <div className="itemsFav"><span>{itemsFav}</span></div> : null}
                  <Routes><Route path='/Sneakers-App/favorites' element={<div className='routeIcon'></div>}/></Routes>
